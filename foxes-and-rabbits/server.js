...
// ── SET YOUR GAME LOCATION HERE ────────────────────────────
const MAP_CENTER    = { lat: 31.15270, lng: 121.47800 };
const MAP_HALF_SPAN = 0.0015;
const MAP_BOUNDS    = {
    minLat: MAP_CENTER.lat - MAP_HALF_SPAN,
    maxLat: MAP_CENTER.lat + MAP_HALF_SPAN,
    minLng: MAP_CENTER.lng - MAP_HALF_SPAN,
    maxLng: MAP_CENTER.lng + MAP_HALF_SPAN,
};
